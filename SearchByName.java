...
public class SearchByName extends JFrame implements ActionListener {
	int id; String dept, name,sname; double mid, fin;
	...
	public void searchFile(String sname){
		try{file.seek(0);
			while(true){
				id = file.readInt();
				dept = file.readUTF();
	...
	public static void main(String[] args) throws IOException{
		SearchByName f = new SearchByName(); 
		f.setVisible(true);  
    	f.setSize(500,400);
